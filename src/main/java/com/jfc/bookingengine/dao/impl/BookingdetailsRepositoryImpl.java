...
import com.jfc.bookingengine.dao.BookingdetailsRepository;
...
public class BookingdetailsRepositoryImpl implements BookingdetailsRepository {
    ...
    public List<Person> findAll() {
        return entityManager.createNamedQuery("Bookingdetails.findAll").getResultList();
    }
    ...
    public <T> T findById(T t) throws RepositoryException {
        EntityTransaction transaction = entityManager.getTransaction();
        Query createNamedQuery = entityManager.createNamedQuery("Bookingdetails.findByBookingDetailsId");
        List resultList = null;
        try {
            transaction.begin();
            createNamedQuery.setParameter("bookingDetailsId", t);
