...
import com.jfc.bookingengine.dao.GenderRepository;
...
public class GenderRepositoryImpl implements GenderRepository {
    ...
    public List<Person> findAll() {
        return entityManager.createNamedQuery("Gender.findAll").getResultList();
    }
    ...
    public <T> T findById(T t) throws RepositoryException {
        EntityTransaction transaction = entityManager.getTransaction();
        Query createNamedQuery = entityManager.createNamedQuery("Gender.findByGenderId");
        List resultList = null;
        try {
            transaction.begin();
            createNamedQuery.setParameter("genderId", t);
