...
import com.jfc.bookingengine.dao.BookingRepository;
...
public class BookingRepositoryImpl implements BookingRepository {
    ...
    public List<Person> findAll() {
        return entityManager.createNamedQuery("Booking.findAll").getResultList();
    }
    ...
    public <T> T findById(T t) throws RepositoryException {
        EntityTransaction transaction = entityManager.getTransaction();
        Query createNamedQuery = entityManager.createNamedQuery("Booking.findByBookingId");
        List resultList = null;
        try {
            transaction.begin();
            createNamedQuery.setParameter("bookingId", t);
