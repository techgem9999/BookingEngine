...
import com.jfc.bookingengine.dao.RoomtypeRepository;
...
public class RoomtypeRepositoryImpl implements RoomtypeRepository {
    ...
    public List<Person> findAll() {
        return entityManager.createNamedQuery("Roomtype.findAll").getResultList();
    }
    ...
    public <T> T findById(T t) throws RepositoryException {
        EntityTransaction transaction = entityManager.getTransaction();
        Query createNamedQuery = entityManager.createNamedQuery("Roomtype.findByRoomTypeId");
        List resultList = null;
        try {
            transaction.begin();
            createNamedQuery.setParameter("roomTypeId", t);
