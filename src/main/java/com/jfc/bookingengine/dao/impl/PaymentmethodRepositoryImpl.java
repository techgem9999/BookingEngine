...
import com.jfc.bookingengine.dao.PaymentmethodRepository;
...
public class PaymentmethodRepositoryImpl implements PaymentmethodRepository {
    ...
    public List<Person> findAll() {
        return entityManager.createNamedQuery("Paymentmethod.findAll").getResultList();
    }
    ...
    public <T> T findById(T t) throws RepositoryException {
        EntityTransaction transaction = entityManager.getTransaction();
        Query createNamedQuery = entityManager.createNamedQuery("Paymentmethod.findByPaymentMethodId");
        List resultList = null;
        try {
            transaction.begin();
            createNamedQuery.setParameter("paymentMethodId", t);
