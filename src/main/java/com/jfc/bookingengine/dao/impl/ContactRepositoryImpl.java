...
import com.jfc.bookingengine.dao.ContactRepository;
...
public class ContactRepositoryImpl implements ContactRepository {
    ...
    public <T> T findById(T t) throws RepositoryException {
        EntityTransaction transaction = entityManager.getTransaction();
        Query createNamedQuery = entityManager.createNamedQuery("Contact.findByContactId");
        List resultList = null;
        try {
            transaction.begin();
            createNamedQuery.setParameter("contactId", t);
