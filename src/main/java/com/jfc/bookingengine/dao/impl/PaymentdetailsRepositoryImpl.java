...
import com.jfc.bookingengine.dao.PaymentdetailsRepository;
...
public class PaymentdetailsRepositoryImpl implements PaymentdetailsRepository {
    ...
    public List<Person> findAll() {
        return entityManager.createNamedQuery("Paymentdetails.findAll").getResultList();
    }
    ...
    public <T> T findById(T t) throws RepositoryException {
        EntityTransaction transaction = entityManager.getTransaction();
        Query createNamedQuery = entityManager.createNamedQuery("Paymentdetails.findByPaymentDetailsId");
        List resultList = null;
        try {
            transaction.begin();
            createNamedQuery.setParameter("paymentDetailsId", t);
