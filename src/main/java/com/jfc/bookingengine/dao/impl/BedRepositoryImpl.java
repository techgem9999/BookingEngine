...
import com.jfc.bookingengine.dao.BedRepository;
...
public class BedRepositoryImpl implements BedRepository {
    ...
    public List<Person> findAll() {
        return entityManager.createNamedQuery("Bed.findAll").getResultList();
    }
    ...
    public <T> T findById(T t) throws RepositoryException {
        EntityTransaction transaction = entityManager.getTransaction();
        Query createNamedQuery = entityManager.createNamedQuery("Bed.findByBedId");
        List resultList = null;
        try {
            transaction.begin();
            createNamedQuery.setParameter("bedId", t);
