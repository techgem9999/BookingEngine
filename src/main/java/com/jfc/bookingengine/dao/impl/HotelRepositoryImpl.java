...
import com.jfc.bookingengine.dao.HotelRepository;
...
public class HotelRepositoryImpl implements HotelRepository {
    ...
    public List<Person> findAll() {
        return entityManager.createNamedQuery("Hotel.findAll").getResultList();
    }
    ...
    public <T> T findById(T t) throws RepositoryException {
        EntityTransaction transaction = entityManager.getTransaction();
        Query createNamedQuery = entityManager.createNamedQuery("Hotel.findByHotelId");
        List resultList = null;
        try {
            transaction.begin();
            createNamedQuery.setParameter("hotelId", t);
