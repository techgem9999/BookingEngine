...
import com.jfc.bookingengine.dao.CustomerRepository;
...
public class CustomerRepositoryImpl implements CustomerRepository {
    ...
    public <T> T findById(T t) throws RepositoryException {
        EntityTransaction transaction = entityManager.getTransaction();
        Query createNamedQuery = entityManager.createNamedQuery("Customer.findByCustomerId");
        List resultList = null;
        try {
            transaction.begin();
            createNamedQuery.setParameter("customerId", t);
