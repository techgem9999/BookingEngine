...
import com.jfc.bookingengine.dao.RoomarchiveRepository;
 ...
 * @author jfc
 */
public class RoomarchiveRepositoryImpl implements RoomarchiveRepository {
    ...
    public List<Person> findAll() {
        return entityManager.createNamedQuery("Roomarchive.findAll").getResultList();
    }
    ...
    public <T> T findById(T t) throws RepositoryException {
        EntityTransaction transaction = entityManager.getTransaction();
        Query createNamedQuery = entityManager.createNamedQuery("Roomarchive.findByRoomArchiveId");
        List resultList = null;
        try {
            transaction.begin();
            createNamedQuery.setParameter("roomArchiveId", t);
