...
import com.jfc.bookingengine.dao.RoomdetailsRepository;
 ...
 * @author jfc
 */
public class RoomdetailsRepositoryImpl implements RoomdetailsRepository {
    ...
    public List<Person> findAll() {
        return entityManager.createNamedQuery("Roomdetails.findAll").getResultList();
    }
    ...
    public <T> T findById(T t) throws RepositoryException {
        EntityTransaction transaction = entityManager.getTransaction();
        Query createNamedQuery = entityManager.createNamedQuery("Roomdetails.findByRoomDetailsId");
        List resultList = null;
        try {
            transaction.begin();
            createNamedQuery.setParameter("roomDetailsId", t);
